...
htmlhelp_basename = 'shellstreamingdoc'
...
latex_documents = [
  ('index', 'shellstreaming.tex', u'shellstreaming Documentation',
   u'Sho Nakatani', 'manual'),
]
...
man_pages = [
    ('index', 'shellstreaming', u'shellstreaming Documentation',
     [u'Sho Nakatani'], 1)
]
...
texinfo_documents = [
  ('index', 'shellstreaming', u'shellstreaming Documentation',
   u'Sho Nakatani', 'shellstreaming', 'One line description of project.',
   'Miscellaneous'),
]
