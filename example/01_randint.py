...
def main():
    ...
    randint_stream = api.IStream(RandIntIStream, (0, 100))  # 実際にinputstreamができる場所もシステムで勝手に決める
    api.OutputStream(LocalFileOStream, ('/tmp/result.txt', ), randint_stream, 'localhost')  # => localhost:/tmp/result.txt
